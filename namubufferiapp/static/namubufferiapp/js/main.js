...
$(document).ready(function () {
  ...
  $("#productModal").on("show.bs.modal", function (event) {
    ...
    modal
      .find("#product-modal-inventory")
      .text(button.data("productinventory"));
  });

  $("#receiptModal").on("show.bs.modal", function (event) {
    var button = $(event.relatedTarget);
    var transactionkey =
      button.data("transactionkey") || $(this).data("transactionkey");
    //$('#historyModal').modal('hide');
    $.post("/receipt/", { transaction_key: transactionkey }).done(function (
      data
    ) {
