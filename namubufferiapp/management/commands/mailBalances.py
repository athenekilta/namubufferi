...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        def get_balance_str():
            ...
            return "Balance: {} - {} == {}e".format(
                positive_balance, -negative_balance, overall_balance
            )
        ...
        email_str += "\n\n{}\n".format(get_balance_str())

        mail = EmailMessage(
            subject="Namubufferi - balance sheet {}".format(
