...
docker-compose -f docker-files/docker-compose.yml -f docker-files/docker-compose.dev.yml exec namubufferi /namubufferi/node_modules/.bin/webpack --config /namubufferi/webpack.config.js
